...
namespace tge {
          ...
          const PipelineConfigInfo&     configInfo) 
  {
      ...
      auto bindingDescriptions = TgeModel::Vertex::getBindingDescriptions();
      auto attributeDescriptions = TgeModel::Vertex::getAttributeDescriptions();
  ...
  void TgePipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
